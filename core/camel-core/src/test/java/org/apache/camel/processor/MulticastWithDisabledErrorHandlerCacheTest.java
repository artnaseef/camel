...
public class MulticastWithDisabledErrorHandlerCacheTest extends ContextTestSupport {
    ...
    @Test
    public void testSendMessageToMulticastWithDisabledErrorHandlerCache() throws Exception {
        ...
        Assertions.assertTrue(multicastProcessor.isDisableErrorHandlerCache());
        Assertions.assertEquals(0, errorHandlerCache.size());
    }
    ...
    protected RouteBuilder createRouteBuilder() {
        ...
        return new RouteBuilder() {
            public void configure() {
                ...
                from("direct:a").multicast().id("test-target-processor").disableErrorHandlerCache(true).to("direct:x", "direct:y", "direct:z");
                // END SNIPPET: example
